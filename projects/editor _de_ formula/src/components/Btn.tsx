...
type BtnProps = {
  ...
  title?: string
  /**
   * Acréscimo local: um botão que abre menu precisa dizer isso a quem navega
   * por leitor de tela. A cópia original deste componente no `weknow_ask` não
   * tem estes dois — vale levar para lá quando alguém mexer nele.
   */
